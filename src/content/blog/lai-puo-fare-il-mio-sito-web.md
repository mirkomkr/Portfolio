...
faq:
  - q: "L'AI può creare un sito web?"
    a: "Sì. Strumenti come ChatGPT possono generare codice, testi, strutture di pagina e idee di design. Il punto è che generare qualcosa che assomiglia a un sito non significa costruire un sito professionale, verificato, accessibile, veloce e adatto agli obiettivi reali di un’attività."

  - q: "Posso usare ChatGPT per fare il sito della mia attività?"
    a: "Puoi usarlo come supporto, soprattutto per bozze, testi, idee e parti di codice. Però ChatGPT non conosce davvero la tua attività, i tuoi clienti, la tua zona, i tuoi obiettivi e i vincoli tecnici del progetto. Per un sito che deve rappresentare un’attività, serve comunque una fase di strategia, verifica e costruzione consapevole."

  - q: "Un sito fatto con l'AI è professionale?"
    a: "Dipende da chi lo controlla e da come viene integrato. L’AI può produrre una buona base, ma un sito professionale richiede controllo su codice, contenuti, performance, accessibilità, SEO di base, mobile e sicurezza. Senza revisione umana, il rischio è avere un sito che sembra pronto ma nasconde problemi."

  - q: "Meglio usare l'AI o affidarsi a un web developer?"
    a: "Non è una scelta tra AI e developer. L’AI è uno strumento, il developer è la persona che decide come usarlo, cosa tenere, cosa correggere e cosa scartare. Se il sito deve portare fiducia, contatti o clienti, la competenza umana serve per trasformare l’output dell’AI in un prodotto affidabile."

  - q: "L'AI può occuparsi di SEO, accessibilità e performance?"
    a: "L’AI può suggerire soluzioni, spiegare problemi e generare codice utile. Ma SEO, accessibilità e performance vanno verificate davvero: struttura delle pagine, testi, contrasto, navigazione da tastiera, immagini, velocità, mobile e dati tecnici non possono essere lasciati solo a una risposta generata."

  - q: "Quando ha senso usare l'AI per creare un sito?"
    a: "Ha senso usarla per prototipi, esperimenti, prime bozze, testi iniziali e automazioni di lavoro. Se invece il sito deve rappresentare un’attività, essere trovato online, funzionare bene su mobile e trasmettere fiducia, l’AI da sola non basta: va guidata, controllata e integrata in un progetto solido."
---
