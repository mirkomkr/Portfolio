...
faq:
  - q: "Perché il mio sito non appare su Google?"
    a: "Le cause più comuni sono tre: Google non ha ancora scansionato o indicizzato il sito, il sito è bloccato da un'impostazione tecnica oppure le pagine non sono abbastanza chiare e rilevanti per le ricerche degli utenti. Il primo controllo da fare è su Google Search Console, dove si vede se le pagine sono indicizzate o se ci sono errori."

  - q: "Quanto tempo ci vuole prima che un sito compaia su Google?"
    a: "Non esiste un tempo identico per tutti. Un sito nuovo può comparire dopo pochi giorni, ma in alcuni casi servono settimane o mesi. Dipende dalla struttura tecnica del sito, dalla sitemap, dai link che riceve, dalla qualità dei contenuti e da quanto Google riesce a scansionarlo facilmente."

  - q: "Cosa significa che un sito è indicizzato?"
    a: "Un sito è indicizzato quando Google ha trovato una pagina, l'ha letta e l'ha inserita nel suo archivio. Essere indicizzati però non significa comparire subito tra i primi risultati: per quello servono contenuti utili, struttura corretta, buone prestazioni e segnali di fiducia."

  - q: "Perché il sito compare cercando il mio nome ma non i miei servizi?"
    a: "Se il sito compare cercando il nome dell'attività ma non compare per servizi come 'realizzazione siti web Anzio' o 'parrucchiere Nettuno', il problema non è l'indicizzazione ma la SEO. Google conosce il sito, ma non lo considera ancora abbastanza pertinente o autorevole per quelle ricerche."

  - q: "Un sito lento può posizionarsi male su Google?"
    a: "Sì. La velocità, la stabilità della pagina e l’esperienza su mobile influenzano l’usabilità e possono contribuire alla qualità complessiva percepita da Google. Un sito veloce, stabile e leggibile aiuta soprattutto le persone a navigare meglio e può lavorare meglio anche insieme alla SEO."

  - q: "Google Business Profile aiuta il sito a farsi trovare?"
    a: "Sì, soprattutto per attività locali. Un Google Business Profile completo e verificato aiuta a comparire su Google Maps e nelle ricerche vicino alla tua zona. Se è collegato al sito e contiene informazioni coerenti, rafforza anche la presenza online della tua attività."
---
...
Puoi verificarlo gratis su [PageSpeed Insights](https://pagespeed.web.dev/) — inserisci l'indirizzo del tuo sito e ottieni un report con i problemi specifici da correggere.
...
> **Nota tecnica:** i problemi di indicizzazione più comuni sono: `noindex` lasciato attivo dall'ambiente di staging, sitemap assente o non registrata in Search Console, redirect chain che indeboliscono il segnale tra le pagine, pagine duplicate senza canonical tag, contenuti importanti generati via JavaScript troppo tardi o in modo incoerente per il crawler. Il crawl budget è rilevante soprattutto per siti di grandi dimensioni. Per siti locali con poche decine di pagine, il problema è quasi sempre nella qualità del segnale: testi, link, struttura tecnica, velocità e coerenza delle informazioni.
