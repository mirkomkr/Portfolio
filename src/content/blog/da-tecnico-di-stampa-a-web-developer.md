...
faq:
  - q: "Può un tecnico di stampa diventare un web developer affidabile?"
    a: "Sì, se affronta il cambio con metodo. Il codice si impara, ma precisione, gestione delle scadenze, problem solving e attenzione alla consegna sono abitudini che si costruiscono negli anni. Il mio background nella stampa industriale mi ha dato proprio questo tipo di rigore."

  - q: "Cosa ti ha insegnato la stampa industriale che usi ancora oggi nel web?"
    a: "Mi ha insegnato che ogni errore ha un costo, che prima di produrre bisogna capire bene la richiesta e che il risultato va controllato prima della consegna. Nel web questo si traduce in brief più chiari, test su dispositivi diversi, attenzione alle prestazioni e meno improvvisazione."

  - q: "Cosa distingue un web developer con background produttivo?"
    a: "Chi viene da un ambiente produttivo è abituato a lavorare con vincoli reali: tempi, materiali, macchine, consegne e responsabilità verso il cliente. Questo approccio porta più attenzione alla qualità dell’output, alla verifica tecnica e alla chiarezza nella comunicazione."

  - q: "Quali competenze della stampa sono utili nello sviluppo web?"
    a: "Precisione visiva, controllo dell’output, gestione del colore, attenzione alla tipografia e capacità di verificare il risultato finale sono competenze molto utili anche nel web. Nel frontend contano layout, leggibilità, coerenza visiva e cura dei dettagli: aspetti che hanno molto in comune con il mondo della prestampa e della produzione."

  - q: "Hai dovuto imparare tutto da zero?"
    a: "Sì e no. Il codice, l’architettura frontend, l’accessibilità e la SEO tecnica sono competenze che ho dovuto studiare da zero. Ma il metodo di lavoro, la precisione e l’abitudine a risolvere problemi complessi venivano già da anni di produzione."

  - q: "Quali certificazioni hai come web developer?"
    a: "Ho conseguito la Meta Front-End Developer Professional Certificate e la certificazione WAI0.1x Introduction to Web Accessibility rilasciata da W3C e edX. Mi sono servite per dare struttura allo studio e per verificare le basi su cui stavo costruendo."
---
